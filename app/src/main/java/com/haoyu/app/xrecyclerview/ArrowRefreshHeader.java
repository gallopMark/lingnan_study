...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        ...
        listview_refresh_statu = findViewById(R.id.listview_refresh_statu);
        mStatusTextView = findViewById(R.id.refresh_status_textview);
        iv_loading = findViewById(R.id.xlistview_header_icLoading);
        ...
        mHeaderTimeView = findViewById(R.id.xlistview_header_time);
